...
public class SingleBungee extends AbstractSimulation {
	...
	protected void doStep() {
		...
		for (int i = 0; i < bungee.length; i++) {
			...
			if(i != (bungee.length-1)) {
				...
				Fy1 = yForce(bungee[i], bungee[i+1]);
			}
			else {
				Fx1 = 0;
				Fy1 = -1 * bungee[bungee.length-1].mass * g;
			}
	...
	public void initialize() {
		...
		bungee[bungee.length-1].mass = 60.25;
	...
	public static void main(String[] args) {
		SimulationControl.createApp(new SingleBungee());
	}
